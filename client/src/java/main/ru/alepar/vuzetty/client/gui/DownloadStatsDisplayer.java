...
public class DownloadStatsDisplayer {
    ...
    public DownloadStatsDisplayer() {
        ...
        statsPanel.add(downloadSpeedCaption, cc.xy(1, 1));
        downloadSpeedValue = new JLabel();
        downloadSpeedValue.setText(" - ");
        statsPanel.add(downloadSpeedValue, cc.xy(3, 1));

        etaCaption = new JLabel();
        etaCaption.setText("ETA  ");
        statsPanel.add(etaCaption, cc.xy(1, 3));
        etaValue = new JLabel();
        etaValue.setText(" - ");
        statsPanel.add(etaValue, cc.xy(3, 3));
        ...
        statsPanel.add(statusCaption, cc.xy(7, 1));
        statusValue = new JLabel();
        statusValue.setText(" - ");
        statsPanel.add(statusValue, cc.xy(9, 1));

        torrentSizeCaption = new JLabel();
        torrentSizeCaption.setText("Size  ");
        statsPanel.add(torrentSizeCaption, cc.xy(7, 3));
        torrentSizeValue = new JLabel();
        torrentSizeValue.setText(" - ");
        statsPanel.add(torrentSizeValue, cc.xy(9, 3));
    }
